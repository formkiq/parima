...
for region in ${StringArray[@]}; do
   aws serverlessrepo delete-application --application-id arn:aws:serverlessrepo:$region:622653865277:applications/FormKiQ-Parima --region $region --profile formkiq
done
