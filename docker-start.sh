...
aws s3 cp /Users/slycer/Documents/workspace/java/parima/parima.yml s3://formkiq-distribution-us-east-1-core/parima/v1.2/parima.yml --acl public-read --endpoint http://localhost:4566
aws s3 cp /Users/slycer/Documents/workspace/java/parima/build/deployment.zip s3://formkiq-distribution-us-east-1-core/parima/v1.2/deployment.zip --acl public-read --endpoint http://localhost:4566

aws s3 cp /Users/slycer/Documents/workspace/java/parima/src/lambda/layer_git/layer-git-2.28.0.zip s3://formkiq-distribution-us-east-1-core/parima/v1.2/parima/layers/layer-git-2.28.0.zip --acl public-read --endpoint http://localhost:4566
